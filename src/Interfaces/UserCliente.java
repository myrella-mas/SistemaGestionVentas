...
public class UserCliente extends javax.swing.JFrame {

    /**
     * Creates new form userCliente
     */
    public UserCliente(ClienteTO clie) {
        initComponents();
        labelbienvenido.setText("Cliente "+ clie.getNombre()+" "+clie.getApellido());
    }
    ...
    private void initComponents() {
        ...
        btnComprar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Comprar.png"))); // NOI18N
        btnComprar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnComprarActionPerformed(evt);
            }
        });
        getContentPane().add(btnComprar, new org.netbeans.lib.awtextra.AbsoluteConstraints(201, 228, -1, -1));

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("COMPRAR");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(201, 307, 97, -1));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/userImg.png"))); // NOI18N
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(488, 126, -1, -1));
        ...
        getContentPane().add(labelbienvenido, new org.netbeans.lib.awtextra.AbsoluteConstraints(31, 135, 447, 25));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/fondo1.jpg"))); // NOI18N
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 580, 340));
    ...
    private void btnComprarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnComprarActionPerformed
        ...
        Venta v = new Venta();//instancia de jframe 
        v.setVisible(true);  //LLama a jfram 
